...
namespace NHTSAVehicleAPI
{
    ...
    public class ReadAPI
    {
        ...
        /// <summary>
        /// Get All Makes from the NHTSA
        /// <seealso cref="https://vpic.nhtsa.dot.gov/api/vehicles/getallmakes?format=XML" />
        /// </summary>
        ...
        public Schema.GetAllVehicleMakes GetAllMakes()
        {
            ...
            return SerializeConfig<Schema.GetAllVehicleMakes>.DeSerialize(pathToXML);
        }

        /// <summary>
        /// Get all manufacturers from the NHTSA
        /// <seealso cref="https://vpic.nhtsa.dot.gov/api/vehicles/getallmanufacturers?format=XML&amp;page=2" />
        /// </summary>
        ...
        public Schema.GetModelsForMake GetAllManufacturers()
        {
            ...
            string url = string.Join(string.Empty, VehicleAPI, Method, "?" + Format);
            string pathToXML = this.DownloadXML(url);
            return SerializeConfig<Schema.GetModelsForMake>.DeSerialize(pathToXML);
        }

        /// <summary>
        /// Get the manufacturer details for some make from the NHTSA
        /// <seealso cref="https://vpic.nhtsa.dot.gov/api/vehicles/getmanufacturerdetails/honda?format=XML" />
        /// </summary>
        ...
        /// <summary>
        /// Get Models for a Make and Year from the NHTSA
        /// <seealso cref="https://vpic.nhtsa.dot.gov/api/vehicles/getmodelsformakeyear/make/honda/modelyear/2015?format=xml" />
        /// </summary>
        ...
        public Schema.GetMakeModels GetModels(string make, int year)
        {
            ...
            string pathToXML = this.DownloadXML(url);
            return SerializeConfig<Schema.GetMakeModels>.DeSerialize(pathToXML);
        }

        /// <summary>
        /// Get Models for a Make and Year from the NHTSA
        /// <seealso cref="https://vpic.nhtsa.dot.gov/api/vehicles/GetModelsForMakeId/440?format=xml"/>
        /// </summary>
        ...
        /// <summary>
        /// Get Models for a Make and Year from the NHTSA
        /// <seealso cref="https://vpic.nhtsa.dot.gov/api/vehicles/getmodelsformake/honda?format=xml" />
        /// </summary>
        /// <param name="make">The Make that you want models for</param>
        /// <returns><see cref="Schema.ModelsForMake.Response"/> for the <c>NHTSA</c> <c>API</c> </returns>
