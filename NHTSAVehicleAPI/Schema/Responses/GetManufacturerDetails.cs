...
namespace NHTSAVehicleAPI.Schema
{
    ...
    /// </summary>
    /// <remarks>
    /// Notice that the NHTSA has a spelling mistake with the <c>Reponse</c> element. On the other's
    /// I have worked with so far, it was spelt, "Response".
    /// </remarks>
    [DataContract]
    ...
    public class GetManufacturerDetails : ResponseBase
    {
        ...
        [DataMember]
        [XmlArray("Results")]
        [XmlArrayItem("ManufacturerDetails")]
